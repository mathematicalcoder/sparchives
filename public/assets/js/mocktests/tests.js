...
function showQuestions(details, questions, hps) {
  ...
  <ol>
    ...
    <li>Answers that require words are not case sensitive and ignore all whitespace before and after the answer. For example, if the correct answer is “<code>apple</code>”, both “<code>ApPlE</code>” and “<code>   apple  </code>” count as correct answers.</li>
  </ol>
  `  // show instructions
